...
import { TabLinkStyle } from "../../Styles/Header";

interface ITabLinkFunc extends ILink {
  handleLinkClick: () => void;
}
export const TabLink: React.FC<ITabLinkFunc> = ({
  handleLinkClick,
  name,
  $isSelected,
}) => {
  return (
    <TabLinkStyle onClick={handleLinkClick} $isSelected={$isSelected}>
      {name}
    </TabLinkStyle>
  );
};
